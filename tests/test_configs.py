...
def main():
    """init all the things"""
    NETWORK_NAME = "NETWORK_BUILDER_LAB"
    SNAPSHOT_NAME = "Generated_Configs"
    SNAPSHOT_DIR = "./network_builder/"  # '../../networks/example'
    BF_SERVICE_IP = "localhost"

    # Define batfish service location
